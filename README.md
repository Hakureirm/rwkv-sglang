...
| 5 | Pascal+/AMD/Intel/domestic; PP+TP; zero2/3; autotune | ◑ greedy-EXACT on 10 GPU types Turing→Blackwell; **TP (head-parallel) + PP (layer partition) both greedy-EXACT 24/24 on real 2×L4** (tp=1/pp=1 zero regression; W4/W8 still tp=1; [`docs/findings/0019`](docs/findings/0019-tp-pp-parallel.md)); ⬜ Pascal/AMD/Intel untested, training/autotune out of scope |
