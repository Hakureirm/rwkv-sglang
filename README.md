...
| **Quantization** | int8 (weight-only, greedy-lossless) and int4 (GPTQ) with hand-written CUDA kernels — faster than fp16 at small batch on every GPU tested; ready-to-use checkpoints on ModelScope |
