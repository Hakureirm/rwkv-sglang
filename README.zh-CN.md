...
**3b. 手写 weight-only int8(w8a16):贪心逐-token 精确且快于 fp16**——24/24 精确(实践无损),
解码 bsz 1/2/4/8 为 fp16 的 1.37×/1.31×/1.27×/**1.06×**(227/392/732/1181 tok/s),且 **全架构可跑**
(按架构 JIT)——不同于 cutlass w8a8(仅 sm80–90)。`RWKV_W8=1`;详见
