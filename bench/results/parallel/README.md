...
Per-run raw engine transcripts are kept outside the repo (available on
request); the committed evidence is this matrix + `../multigpu.md` +
`../allcards.json` (per-cell greedy parity + tok/s).
